...
const Testimonials = () => {
  return (
    <div className='overflow-x-hidden pt-4 bg-gray-100'>
      ...
      <div className="flex flex-row w-full overflow-x-auto" id="testimonial">
        <div className='flex flex-col flex-none p-2 m-1 bg-white shadow-lg rounded-lg w-full md:w-1/3'>
        ...
        <div className='flex flex-col p-2 m-2 flex-none bg-white shadow-lg rounded-lg w-full md:w-1/3'>

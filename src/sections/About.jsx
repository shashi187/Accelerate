...
const About = () => {
  ...
  return (
    <div className="bg-gray-100 overflow-hidden">
      <div className="w-full bg-gray-100 md:bg-white my-5 mt-8 flex flex-col m-1">
        <h1 className="text-center text-[8.2vw] md:text-[7vw] md:font-medium md:pb-8 font-bold bg-white text-black">
          About Us
        </h1>
        <div className="md:flex md:justify-around">
          <div
            ...
            className="p-5 bg-white md:w-1/3 overflow-hidden"
          >
            <div
              ref={tiltref}
              id="tilt"
              className="bg-white place-self-center pl-10 md:pl-0"
            >
              <img
          ...
          <div className="bg-white p-5 rounded-lg h-200px md:w-2/3 shadow-gray-400 md:shadow-none shadow-2xl">
